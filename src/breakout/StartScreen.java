...
public class StartScreen {
    ...
    public Rectangle generateHypno(){
    ...
    public StartScreen(Main mainGame){
        ...
        cont.setOnAction(e -> mainGame.advanceScene(mainGame.getGameScene()));
        ...
        startScene = new Scene(startRoot, mainGame.getSize()+100, mainGame.getSize()+100, mainGame.getBackground());
    }
